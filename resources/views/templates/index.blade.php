...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <p class="lead">The first product management system designed for beginners. Simple, powerful, and completely free!</p>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="service-card text-center">
                        ...
                        <p>Manage your products with lightning-fast performance and intuitive workflows designed for maximum productivity.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service-card text-center">
                        ...
                        <p>Your data is protected with industry-standard security measures and reliable backup systems.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service-card text-center">
                        ...
                        <p>Designed specifically for beginners with easy-to-use interfaces and helpful guides every step of the way.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="faq-item">
                        ...
                        <p class="mb-0">PMS is the first product management system designed for beginners. It provides an intuitive platform to manage your products efficiently.</p>
                    </div>
                    <div class="faq-item">
                    ...
                    <div class="faq-item">
                        <div class="faq-question"><i class="bi bi-question-circle"></i> Is there a technical support team?</div>
                        <p class="mb-0">We have the best support team that is available 24/7 to help you with any questions or issues.</p>
                    </div>
                </div>
            </div>
        </div>
